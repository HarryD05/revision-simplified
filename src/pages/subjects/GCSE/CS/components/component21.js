  ...
  return (
    <div id="comp2_1" className="topic">
      ...
      <ul>
        ...
        <li><b>Pseudocode</b> - A method of describing an algorithm using a structure similar to a programming language</li>
      ...
      <ul>
        <li><a href="https://beta.ocr.org.uk/Images/202654-pseudocode-guide.pdf" target="blank" rel="noopener noreferrer">Pseudocode guide</a> from OCR</li>
      </ul>
    </div>
  )
}

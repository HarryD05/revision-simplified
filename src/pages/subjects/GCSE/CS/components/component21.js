	...
	return (
		<div id="comp2_1" className="topic">
			...
			<div className="key-words">
				...
				<ul>
					<li>
						<b>Flow diagram</b> - Graphical representation of an algorithm
					</li>
					<li>
						<b>Pseudocode</b> - A method of describing an algorithm using a structure similar to a
						programming language
					</li>
					<li>
						<b>Algorithm</b> - Step-by-step procedure used to complete a specific task
					</li>
				</ul>
			</div>
			...
			<ul>
				...
				<ul>
					<li>
						Logical way of getting from problem to solution, following an algorithm or set of steps (that
						can be modified and used to solve similar issues)
					</li>
				</ul>
			</ul>
			...
			<ul>
				...
				<ul>
					...
					<li>
						If not check if the target is more or less than the current middle value, if it is more get rid
						of the left side, if it is less then then the right side
					</li>
				...
				<li>
					<b>
						Linear <em>(unordered list)</em>
					</b>
				</li>
				<ul>
					<li>
						Search through every item left to right and check if the number is the target, if it is stop
					</li>
					<li>
						Linear searches are simpler but not as efficient (linear should only be used for small lists)
					</li>
				</ul>
			</ul>
			...
			<ul>
				...
				<ul>
					...
					<ul>
						...
						<li>
							Reaching the end of the list is a pass, once a pass is completed without a swap the list is
							sorted
						</li>
					</ul>
					...
					<div className="advantages">
						...
						<ul>
							...
							<li>
								Efficient way to check if the algorithm is already ordered, as only 1 pass will take
								place (n – 1 comparisons)
							</li>
				...
				<ul>
					...
					<ul>
						...
						<li>
							Merge the lists so that each new list has doubled in size (merge them by placing the
							smallest number into the new list each item)
						</li>
